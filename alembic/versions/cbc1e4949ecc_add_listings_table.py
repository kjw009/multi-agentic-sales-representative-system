...
down_revision: Union[str, None] = '4705c798e249'
...
def upgrade() -> None:
    ...
    sa.Column('platform', postgresql.ENUM('ebay', name='platform', create_type=False), nullable=False),
    sa.Column('external_id', sa.String(length=255), nullable=True),
    sa.Column('url', sa.String(length=2048), nullable=True),
    sa.Column('status', postgresql.ENUM('publishing', 'live', 'ended', 'error', name='listing_status', create_type=False), nullable=False),
